...
if os.path.exists('.env'):
    click.echo('Importing environment from .env...')
...
def create_app(info):
    ...
    return create_app(os.environ.get('BYTARDAG_CONFIG') or 'default')


@click.group(cls=FlaskGroup, create_app=create_app)
def cli():
    """Web application management script."""
    pass
...
def sass():
    """Compile SASS files."""
    click.echo('Compiling SASS files...')
